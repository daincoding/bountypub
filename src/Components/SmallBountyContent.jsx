        ...
        <div className="w-full md:w-2/5 p-0 rounded-lg shadow-md border-4 border-btn-primary max-h-[60vh]">
          ...
          >
            ...
            <div className="overflow-y-auto flex-grow mb-4 pr-2">
              ...
              <p className="mb-4">
              Kill both Ancestor Spirits with any additional difficulty above! See rules below:
              </p>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  📫 Submission deadline is: Saturday, March 29 at 1pm EST
                </li>
            ...
            <div className="flex flex-col space-y-2">
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSfdF_uaG1jc1WEz3hawJ5BWqc4WV1mfHKHx0ApUXRmzbH9mHA/viewform"
                target="_blank"
