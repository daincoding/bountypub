    ...
    <div className="flex flex-wrap md:flex-nowrap w-full h-full p-4 gap-4">
      ...
      <div className="w-full md:w-2/5 p-0 rounded-lg shadow-md border-4 border-btn-primary max-h-[60vh]">
        ...
        >
          ...
          <p className="mb-4">Kill as many bosses as you can within 3 Hours! See rules below.</p>
          ...
          <div className="flex flex-col space-y-2">
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdDFMrZMllbn-2ZAw5EE28EYlPGJjUMZ3MKYXpJVlUt-4ueZA/viewform"
              target="_blank"
